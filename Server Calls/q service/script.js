...
angular.module("mainModule", [])
	.controller("mainController", function($scope, $q, $http) {
		...
		$scope.aggregatedHTTPAsyncFunc = function(call1Success, call2Success, call3Success){
			...
			var promise = $q.all([
				$http.get((call1Success ? "server.php" : "invalid_url.php"), getCallParams("Call1", 5 )),
				$http.get((call2Success ? "server.php" : "invalid_url.php"), getCallParams("Call2", 4 )),
				$http.get((call3Success ? "server.php" : "invalid_url.php"), getCallParams("Call3", 3 ))			
			]);
